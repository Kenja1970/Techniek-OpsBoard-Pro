...
### Fixed
- Card editor stage changes now use the same stage-driven progress propagation as drag/drop moves, so saving a card into another column updates percent complete, earned value, reports, ordering, and activity consistently.

### QA / QC
- Browser QA expanded to **229 checks** with a focused editor-stage save propagation group.
