...
4. Run `pnpm run release` to validate guardrails and refresh `opsboard/`, then run the QA suite (`tests/qa.html`) and update `docs/qa/QA-REPORT.md` with the result.
