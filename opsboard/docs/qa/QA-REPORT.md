...
**Version:** 2.5.1  
**Result:** ✅ **226 / 226 checks passed · 0 failures**  
...
| 8b | Stage drives % complete → reports stay in sync | 7 | ✅ 7/7 |
...
v2.5.1 passes **226/226** with zero console errors. This round adds regression coverage proving that card stage changes saved from the edit modal recompute stage-implied progress and move Earned Value, matching drag/drop behavior. The suite is committed so every future change (including the nightly routine) can be re-validated.
